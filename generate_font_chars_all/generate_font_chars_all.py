...
if not os.path.isdir(fontPathThai):
    os.makedirs(fontPathThai)
...
# Thai type 1
    ...
    for i in range(0x0E5A,0x0E5B+2): # Signs
        thaiSignCharList.append(chr(i))
        allCharList.append(chr(i))
    ...
    for fontSeq in range(len(fontAllList))    :
        ...
        while True:
            ...
            pageCharFile = labelFile + '-' + str(seqNo) + '-' + fontName + "_genchar" + '.txt'
            ...
            for lineNo in range(lineNoPerPage):
                ...
                for charNo in range(charNoPerLine):
                    ...
                    if fontSeq < len(fontThaiList) :
                        charCard = make_char_font_image(character, 'ThaFont', fontSeq)

                    # print("fontSeq : ",fontSeq)
                    # print("len fontEnglish : ",len(fontEnglish)-fontSeq)
                    '''
